...
export class SDK_Wechat  {
    ...
    share(titleStr: string){
        ...
        //平台上的分享图片链接地址
        let imgUrls = ['https://mmocgame.qpic.cn/wechatgame/CWMAEXxkI6WWoZXptOAPAyRTicjy7V6cbia2vlvKeW9iapo6wEAmIaZbmojibDCagia8R/0'];
        //平台上的分享图片编号
        let imgIds = ['9hIrGcGNSfq67iD6w4UZLw'];
