...
class MyUserManager {
    ...
    checkUserName(){
        ...
        if(MyUserData.UserName && MyUserData.UserName.indexOf("垃圾") >= 0 && MyUserData.UserName.length > 10){
        }else{
            MyUserData.UserName = "垃圾_"+Math.ceil(Math.random()*99)+"_"+(new Date().getTime());
