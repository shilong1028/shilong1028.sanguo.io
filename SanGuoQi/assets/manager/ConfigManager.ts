...
class CfgMgr_class {
    ...
    getTaskConf(taskId: number): st_story_info{
        return this.C_talk_info[taskId];
    }
...
export class st_battle_info{
    ...
    transType(){
        ...
        this.solider = Cfg.getKeyValAry(this.solider);
        this.general = Cfg.getIntAry(this.general, ";");
    }
}
...
export class st_city_info {
    ...
    transType(){
        ...
        this.near_citys = Cfg.getIntAry(this.near_citys, ";");
        this.counties = Cfg.getStringAry(this.counties, ";");
    }
}
...
export class st_story_info{
    ...
    transType(){
        ...
        this.reward = Cfg.getKeyValAry(this.reward, ";");
        this.talk = Cfg.getIntAry(this.talk, ";");
    }
}
