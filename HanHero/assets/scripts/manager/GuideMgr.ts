 ...
 * @LastEditors: dongsl
 * @LastEditTime: 2021-03-20 14:56:20
 * @Description: 
 */
import { GameMgr } from "./GameManager";
import { LoaderMgr } from "./LoaderManager";
import { MyUserMgr } from "./MyUserData";
import { st_guide_info, CfgMgr } from "./ConfigManager";
import { ROOT_NODE } from "../login/rootNode";
import GuideLayer from '../comui/guideLayer';
...
class GuideMgr_class {
    ...
    endGuide_NewPlayer(step: GuideStepEnum) {
        ...
        if (this.checkKeyStep(step) > 0) {
            MyUserMgr.updateGuideStepData(this.getFinishGuideStr());
        }
    }
